...
const MarketPostFormBox = ({ picturePath }) => {
  ...
  const handlePost = async () => {
    ...
    const response = await fetch(`http://localhost:3001/marketposts`, {
      method: "POST",
    ...
    <LayoutWrap>
      ...
      <Layout gap="1.5rem">
        ...
        {isNonMobileScreens ? (
          <>
            <Layout gap="0.25rem">
              <MonetizationOnOutlined sx={{ color: mediumMain }} />
              <Typography color={mediumMain}>Price</Typography>
            </Layout>

            <Layout gap="0.25rem">
              <CategoryOutlined sx={{ color: mediumMain }} />
              <Typography color={mediumMain}>Product Type</Typography>
            </Layout>
...
export default MarketPostFormBox;
