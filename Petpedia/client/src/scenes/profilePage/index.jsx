...
import ProfileNavbar from "scenes/ProfileNavbar";
    ...
    <Box>
      ...
      >
        <Box flexBasis={isNonMobileScreens ? "26%" : undefined}>
          <UserInfoBox userId={userId} picturePath={user.picturePath} />
          <Box m="2rem 0" />
        ...
        >
          <PostFormBox picturePath={user.picturePath} />
          <Box m="2rem 0" />
          <PostsBox userId={userId} isProfile />
        </Box>
      </Box>
    </Box>
  );
